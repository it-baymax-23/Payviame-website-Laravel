                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-stats">
                                ...
                                <div class="card-content">
                                    <p class="category">{{ __('Total Invoices') }}</p>
                                    <h3 class="title">{{ $invoiceCount }}
                                    </h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content">
                                    <p class="category">{{ __('PAID') }}</p>
                                    <h3 class="title">{{$current_currency->currency_symbol}} {{$paid}} {{$current_currency->currency_code}}
                                    </h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content">
                                    <p class="category">{{ __('OWING') }}</p>
                                    <h3 class="title">{{$current_currency->currency_symbol}} {{$owing}} {{$current_currency->currency_code}}
                                    </h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content">
                                    <p class="category">{{ __('OVERDUE') }}</p>
                                    <h3 class="title">{{$current_currency->currency_symbol}} {{$overdue}} {{$current_currency->currency_code}}
                                    </h3>
                                </div>
                            </div>
                        </div>
...
@push('scripts')
    ...
    <script>
        ...
        $('#exampleFormControlSelect1').change(function(){
            ...
            if (currency_id == 0)
                currency_id = 1;
            url = '{{config('app.url')}}' + '/admin/invoice/' + account_id + '/' + currency_id;
