                    ...
                    <div class="right-penal">   
                        <div style="position: relative;top: -32px;"> 
                            <ul class="nav nav-tabs page-tab">
                                <li class="nav-item">
                                    <a class="nav-link active" href="{{ route('client.index') }}">{{__('Current')}}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('client.archived') }} ">{{__('Archived')}}</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <table id="example" class="table table-striped table-bordered mb-5"  width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="th-sm">{{__('Overdue')}}<i class="fa fa-arrows-v"></i>
                                    </th>
                                    ...
                                    <td style="vertical-align: middle; height: 45px; border-bottom: 1px grey solid">
                                        <div class="client-business-name">
                                            <a href="{{route('client.show',$client->id)}}">
                                                ...
                                                @else
                                                <img src="{{asset($client->client_logo)}}" width="40" height="40">
                                                @endif
                ...
                <div id="menu2" class="container tab-pane fade">
                    ...
                    <div class="report-contents">
                        <div class="info">
                            ...
                            {{__('You don\'t have any projects with an estimated duration. Here\'s an example of what this report would look like if you did:')}}
                            </p>
                        </div>
                        <img style="max-width: 950px; display: block; margin: 0 auto;" src="{{ asset('frontend/images/project-budgets1.png') }}">
                    </div>
                </div>
            </div>
