    ...
    <div id="invoice-page">
        <div id="invoice_contents" style="max-width: 800px">
            <div class="logo_bar">
                ...
                @else
                <img src="{{ asset($quote->account->user->profile->company_logo) }}" alt="Paydirt logo" height="50">
                @endif
            </div>
            <table>
                <tr>
                    <td style="width: 27%; border-bottom: 1px solid lightgrey;">
                        <p style="font-size: 10px;">From &nbsp;&nbsp; {{ $quote->account->user->profile->business_name }}</p>
                    </td>
                    <td style="width: 2%;"></td>
                    <td style="width: 27%; border-bottom: 1px solid lightgrey;">
                        <p style="font-size: 10px;">To &nbsp;&nbsp; {{ $quote->client->business_name }}</p>
                    </td>
                    <td style="width: 8%;"></td>
                    <td style="width: 20%; border-bottom: 1px solid lightgrey;">
                        <p style="font-size: 10px;">Quote</p>
                    </td>
                    <td style="width: 16%; border-bottom: 1px solid lightgrey;">
                        <p class="formatted-number" style="font-weight: bold; font-size: 10px">{{ $quote->id }}</p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <span style="font-size: 8px; color: #636b6f;">
                            <br/>
                            {{ $quote->account->user->profile->contact_name }}
                            <br/>
                            Reg. Nr. {{ $quote->account->user->profile->company_number }}
                            <br/>
                            VAT Nr. {{ $quote->account->user->profile->vat_number }}
                            <br/>
                            Address: {{ $quote->account->user->profile->business_address }}
                        </span>
                    </td>
                    <td></td>
                    <td>
                    ...
                    <td colspan="2">
                        ...
                        <div class="amount_due">
                            <b>Total: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b> <b>{{ $quote->currency->currency_symbol }} {{ $quote->sum_total }}</b> <span style="color: #636b6f;">{{ $quote->currency->currency_code }}</span>
                        </div>
                    </td>
                </tr>
            </table>
            ...
            <table style="width: 100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width: 12%; font-size: 8px;">&nbsp;&nbsp;{{ $quote->currency->currency_symbol }} {{ $value->unit_price }}</td>
                        @if($value->tax1 == 1)
                        ...
                        <td style="width: 8%; font-size: 10px;"></td>
                        @endif
                        <td style="width: 12%; font-size: 8px;">{{ $quote->currency->currency_symbol }} {{ $value->amount_price }}</td>
                    </tr>
                    @endforeach
                    @endif
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="right" colspan="2" style="font-size: 10px;"><b>{{ $quote->currency->currency_symbol }} {{ $quote->sub_total }}</b> <span style="color: #636b6f;">{{ $quote->currency->currency_code }}</span></td>
                    </tr>
                    @if(count($taxes))
                      @if(count($taxes) == 2)
                        <tr>
                            ...
                            <td class="right" colspan="2" style="font-size: 10px;"><b>{{ $quote->currency->currency_symbol }} {{$quote->sum_tax1}}</b> <span style="color: #636b6f;"> {{ $quote->currency->currency_code }}</span></td>
                        </tr>
                        <tr>
                            <td colspan="2"></td>
                            <td colspan="2" style="font-size: 10px;">
                            ...
                            <td class="right" colspan="2" style="font-size: 10px;"><b>{{ $quote->currency->currency_symbol }} {{$quote->sum_tax2}}</b> <span style="color: #636b6f;"> {{ $quote->currency->currency_code }}</span></td>
                        </tr>
                      @else
                        <tr>
                            <td colspan="2"></td>
                    ...
                    @endif
                        <tr>
                            ...
                            <td class="right" colspan="2" style="font-size: 10px; border-top: 2px solid #e3e3e3; border-bottom: 1px solid #e3e3e3; background-color: #f6f6f6;"><b>{{ $quote->currency->currency_symbol }} {{ $quote->sum_total }}</b> <span style="color: #636b6f;"> {{ $quote->currency->currency_code }}</span></td>
                        </tr>
                </tbody>
            </table>
            <br/><br/>
