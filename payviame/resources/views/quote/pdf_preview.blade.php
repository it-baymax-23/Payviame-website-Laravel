                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="vertical-align: top">
                                    <div class="dark_grey">
                                      <span>Reg. Nr. {{ $quote->account->user->profile->company_number }}</span><br>
                                      <span>VAT Nr. {{ $quote->account->user->profile->vat_number }}</span><br>
                                      <span>Address: {{ $quote->account->user->profile->business_address }}</span>
                                    </div>
                                </td>
                                <td style="vertical-align: top">
                                    <div class="dark_grey">
                                      @if(!isset($quote->recipient_address))
                                        <p>{{ $quote->client->address_detail }}</p>
                                      @else
                                        <p>{{ $quote->recipient_address }}</p>
                                      @endif
                                    </div>
                                </td>
                            </tr>
                ...
                <div class="span-9 last">
                    <table class="to-from">
                        <tbody>
                            ...
                            <tr>
                                <td style="vertical-align: top">
                                    <div class="dark_grey" style="margin-bottom: 20px;">
                                        <div class="span-12">
                                           <b>Date Issued:</b>
                                        </div>
                            ...
                            <tr>
                                <td>
                                    <div class="amount_due clearfix" style="height: 25px; padding-bottom: 5px; padding-top: 5px; margin-top: 10px">
                                        <div class="span-12">
                                            <b>
                                            Total:
                                            </b>
                                        ...
                                        <div class="span-12 last t-right nowrap" style="margin-left: auto;">
                                            {{ $quote->sum_total }}<span class="currency_code"> {{ $quote->currency->currency_code }}</span>
                                        </div>
                                    </div>
                                </td>
                            </tr>
            ...
            <table id="line_items">
                ...
                <tbody>
                    ...
                    <tr class="line_item odd">
                      ...
                      <td style="width: 10%"></td>
                      @endif
                      <td style="width: 20%;"><span class="right">{{ $value->amount_price }} {{ $quote->currency->currency_code }}</span></td>
                    </tr>
                    @endforeach
                    @endif
                    <tr>
                    ...
                    <tr>
                      ...
                      <td class="nowrap" id="invoice_subtotal" colspan="1">{{ $quote->sub_total }}<span class="currency_code"> {{ $quote->currency->currency_code }}</span></td>
                    </tr>
                    @if(count($taxes))
                      @if(count($taxes) == 2)
                        <tr>
                          ...
                          <td class="nowrap" id="invoice_subtotal" colspan="1">{{$quote->sum_tax1}}<span class="currency_code"> {{ $quote->currency->currency_code }}</span></td>
                        </tr>
                        <tr>
                          <td colspan="5">
                              <b class="right">{{ $taxes[1]->tax_description }} ({{$taxes[1]->tax_percentage}} %)</b>
                          </td>
                          <td class="nowrap" id="invoice_subtotal" colspan="1">{{$quote->sum_tax2}}<span class="currency_code"> {{ $quote->currency->currency_code }}</span></td>
                        </tr>
                      @else
                        <tr>
                          <td colspan="5">
                    ...
                    <tr>
                      ...
                      <td class="amount_due nowrap" id="invoice_total" colspan="1">{{ $quote->sum_total }}<span class="currency_code"> {{ $quote->currency->currency_code }}</span></td>
                    </tr>
                </tbody>
            </table>
            <div class="dark_grey">
